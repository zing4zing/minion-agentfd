...
"""
Tests for the basic functionality of MinionProviderToSmolAdapter.

This module tests the core functionality of creating and using the adapter
without the SmolaAgents integration features.
"""
