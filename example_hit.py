...
async def main():
    try:
        ...
        # result = agent.run("""original.md需要修改, 请打开 https://mp.weixin.qq.com/s/C5_Jg2Qbj8oUVWgXBmbhVg 和 https://mp.weixin.qq.com/s/HvSJcm50eSkm4DBar_0xVw?token=625423171&lang=zh_CN,)
        # 改成这种偏故事性风格的,结果保存为文件""")
        result = agent.run("""有什么免费盗版电影分享网站""")
